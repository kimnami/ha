...
int gen_instr_valid()
{
    return ((if_id_next->icode) == (I_NOP) || (if_id_next->icode) == 
      ...
      (if_id_next->icode) == (I_MRMOVL) || (if_id_next->icode) == (I_IADDL)
       || (if_id_next->icode) == (I_ISUBL) || (if_id_next->icode) == 
      (I_LEAVE) || (if_id_next->icode) == (I_ALU) || (if_id_next->icode)
       == (I_JMP) || (if_id_next->icode) == (I_CALL) || (if_id_next->icode)
       == (I_RET) || (if_id_next->icode) == (I_PUSHL) || 
      (if_id_next->icode) == (I_POPL));
}
...
int gen_need_regids()
{
    return ((if_id_next->icode) == (I_RRMOVL) || (if_id_next->icode) == 
      (I_ALU) || (if_id_next->icode) == (I_PUSHL) || (if_id_next->icode)
       == (I_POPL) || (if_id_next->icode) == (I_IADDL) || 
      (if_id_next->icode) == (I_ISUBL) || (if_id_next->icode) == (I_IRMOVL)
...
int gen_mem_addr()
{
    return (((ex_mem_curr->icode) == (I_RMMOVL) || (ex_mem_curr->icode) == 
        ...
        ) ? (ex_mem_curr->vala) : ((ex_mem_curr->icode) == (I_LEAVE)) ? 
      (ex_mem_curr->vala) : 0);
}
