...
int gen_F_stall()
{
    return ((((id_ex_curr->icode) == (I_MRMOVL)) & (((id_ex_curr->destm)
             == (id_ex_next->srcb)) | (((id_ex_curr->destm) == 
              (id_ex_next->srca)) & !((if_id_curr->icode) == (I_RMMOVL)))))
...
{
    return (((id_ex_curr->icode) == (I_MRMOVL)) & (((id_ex_curr->destm) == 
          (id_ex_next->srcb)) | (((id_ex_curr->destm) == (id_ex_next->srca)
            ) & !((if_id_curr->icode) == (I_RMMOVL)))));
}
...
{
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | (((id_ex_curr->icode) == (I_MRMOVL)) & (((id_ex_curr->destm) == 
            (id_ex_next->srcb)) | (((id_ex_curr->destm) == 
              (id_ex_next->srca)) & !((if_id_curr->icode) == (I_RMMOVL)))))
      );
}
